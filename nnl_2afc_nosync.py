...
expName = 'nnl_2afc_nosync'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/nmuncy2/Projects/code/nd_hnc/nnl_psychopy/nnl_2afc_nosync.py',
